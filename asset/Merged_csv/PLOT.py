...
delay_dot=y_data['DELAY_RATIO']

colorx=['lightcyan','tomato']
featureX='TotalPop_des'         ################# Feature X
featureY='Transit_org'      ################# Feature Y


plot_x=x_data[featureX]
plot_y=x_data[featureY]
plt.scatter(plot_x,plot_y,c=delay_dot,alpha=0.3,cmap=matplotlib.colors.ListedColormap(colorx))
...
############## Select feature: ####################
selector= SelectKBest(score_func= mutual_info_classif, k= 8) ###### mutual_info_classif  f_classif chi2
